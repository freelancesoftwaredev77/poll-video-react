...
const Button: React.FC<IProps> = ({
  ...
  <button
    className={`
      ${className} text-pure-white w-full rounded-md text-center text-xs capitalize outline-none disabled:cursor-not-allowed disabled:bg-opacity-40 disabled:text-opacity-70
